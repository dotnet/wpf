...
namespace System.Windows.Markup.Tests
{
    ...
    {
        [Fact]
        public void CanConvertToString_Invoke_ReturnsFalse()
        {
            var serializer = new CustomValueSerializer();
            Assert.False(serializer.CanConvertToString(null, null));
        }

        [Theory]
        [InlineData(null)]
        [InlineData("value")]
        public void ConvertToString_Invoke_ThrowsNotSupportedException(object value)
        {
            var serializer = new CustomValueSerializer();
        ...
        [Fact]
        public void CanConvertFromString_Invoke_ReturnsFalse()
        {
            var serializer = new CustomValueSerializer();
            Assert.False(serializer.CanConvertFromString(null, null));
        }

        [Theory]
        [InlineData(null)]
        [InlineData("value")]
        public void ConvertFromString_Invoke_ThrowsNotSupportedException(string value)
        {
            var serializer = new CustomValueSerializer();
        ...
        [Fact]
        public void TypeReferences_Invoke_ReturnsEmpty()
        {
            var serializer = new CustomValueSerializer();
            Assert.Empty(serializer.TypeReferences(null, null));
        }
