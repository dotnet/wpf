...
namespace MS.Internal
{
    internal static class SystemDataHelper
    {
        ...
        internal static bool IsDataView(IBindingList list)
        {
            ...
            return (extensions is not null) ? extensions.IsDataView(list) : false;
        }
        ...
        {
            SystemDataExtensionMethods extensions = AssemblyHelper.ExtensionsForSystemData();
            return (extensions is not null) ? extensions.IsDataRowView(item) : false;
        }
        ...
        {
            SystemDataExtensionMethods extensions = AssemblyHelper.ExtensionsForSystemData();
            return (extensions is not null) ? extensions.IsSqlNull(value) : false;
        }
        ...
        {
            SystemDataExtensionMethods extensions = AssemblyHelper.ExtensionsForSystemData();
            return (extensions is not null) ? extensions.IsSqlNullableType(type) : false;
        }
        ...
        {
            SystemDataExtensionMethods extensions = AssemblyHelper.ExtensionsForSystemData();
            return (extensions is not null) ? extensions.IsDataSetCollectionProperty(pd) : false;
        }
        ...
        {
            SystemDataExtensionMethods extensions = AssemblyHelper.ExtensionsForSystemData();
            return (extensions is not null) ? extensions.GetValue(item, pd, useFollowParent) : null;
        }
        ...
        {
            SystemDataExtensionMethods extensions = AssemblyHelper.ExtensionsForSystemData();
            return (extensions is not null) ? extensions.DetermineWhetherDBNullIsValid(item, columnName, arg) : false;
        }
