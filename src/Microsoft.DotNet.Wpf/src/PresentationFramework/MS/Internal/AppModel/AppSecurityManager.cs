...
namespace MS.Internal.AppModel
{
    ...
    {
        /// <summary> 
        /// Launch the browser if you can.
        /// </summary> 
        internal static void SafeLaunchBrowserDemandWhenUnsafe(Uri destinationUri, bool fIsTopLevel)
        {
            if (SafeLaunchBrowserOnlyIfPossible(destinationUri, fIsTopLevel) is LaunchResult.NotLaunched)
            {
                ShellExecuteDefaultBrowser(destinationUri);
            }
        }
        ...
        ///</summary> 
        internal static LaunchResult SafeLaunchBrowserOnlyIfPossible(Uri destinationUri, bool fIsTopLevel)
        {
        ...
        internal static void ShellExecuteDefaultBrowser(Uri uri)
        {
            ...
            */
            ...
            if (!UnsafeNativeMethods.ShellExecuteEx(sei))
                throw new InvalidOperationException(SR.FailToLaunchDefaultBrowser, new Win32Exception(/*uses the last Win32 error*/));
        }
    }
}
