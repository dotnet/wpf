    ...
    sealed partial class CombinedGeometry : Geometry
    {
        ...
        internal override DUCE.ResourceHandle AddRefOnChannelCore(DUCE.Channel channel)
        {
            if (_duceResource.CreateOrAddRefOnChannel(this, channel, System.Windows.Media.Composition.DUCE.ResourceType.TYPE_COMBINEDGEOMETRY))
            {
                ...
                Geometry vGeometry1 = Geometry1;
                if (vGeometry1 != null)
                    ((DUCE.IResource)vGeometry1).AddRefOnChannel(channel);
                Geometry vGeometry2 = Geometry2;
                if (vGeometry2 != null)
                    ((DUCE.IResource)vGeometry2).AddRefOnChannel(channel);
        ...
        internal override void ReleaseOnChannelCore(DUCE.Channel channel)
        {
            ...
            if (_duceResource.ReleaseOnChannel(channel))
            {
                ...
                Geometry vGeometry1 = Geometry1;
                if (vGeometry1 != null)
                    ((DUCE.IResource)vGeometry1).ReleaseOnChannel(channel);
                Geometry vGeometry2 = Geometry2;
                if (vGeometry2 != null)
                    ((DUCE.IResource)vGeometry2).ReleaseOnChannel(channel);
