...
namespace System.Windows.Markup 
{
    ...
    /// converters (like BitmapImage TypeConverters) a way to ensure that base uri
    /// is set on them by the  parser, codegen for xaml, baml and caml cases.
    /// The elements can then use this base uri to navigate.
    ///</summary>
