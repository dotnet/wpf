...
{
    /// <summary>
    /// CustomDockPanel will automatically close its window after it is displayed.
    ...
    /// </summary>
    public class CustomDockPanel : DockPanel, ICustomElement
    {
        /// <summary>
        /// Type+Function to invoke for optional verification.
        /// </summary>
        public static readonly DependencyProperty VerifierProperty = DependencyProperty.RegisterAttached("Verifier", typeof(string), typeof(CustomDockPanel), new PropertyMetadata(""));
