...
{
    /// <summary>
    /// Apply PathGeometry AddGeometry Method.
    /// </summary>
    public class PathGeometryAddGeometryAction : SimpleDiscoverableAction
    {
        ...
        {
            Trace.WriteLine("Perform PathGeometryAddGeometryAction...");
            ((PathGeometry)(UIElement.Clip)).AddGeometry(Geometry);
        }
