...
#endif
{
    ...
    public class RibbonGroupItemsPanel : Panel, IProvideStarLayoutInfo, IContainsStarLayoutManager
    {
        ...
        protected override Size MeasureOverride(Size availableSize)
        {
            ...
            bool isStarLayoutPass = iContainsStarLayoutManager.StarLayoutManager is not null && iContainsStarLayoutManager.StarLayoutManager.IsStarLayoutPass;
        ...
        private List<StarLayoutInfo> _starLayoutCombinations = new List<StarLayoutInfo>();
        private Dictionary<int, int> _childIndexToStarLayoutIndexMap = new Dictionary<int, int>();
