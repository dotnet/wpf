...
/// <summary>
/// Wrapper class for the <see cref="IInvokeProvider"/> interface, calls through to the managed <see cref="AutomationPeer"/>
...
internal sealed class InvokeProviderWrapper : MarshalByRefObject, IInvokeProvider
{
    ...
    /// <summary>
    /// Creates a wrapper for the given <see cref="AutomationPeer"/> and <see cref="IInvokeProvider"/> interface.
    /// </summary>
