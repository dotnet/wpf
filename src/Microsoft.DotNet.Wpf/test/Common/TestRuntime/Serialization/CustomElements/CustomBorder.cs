...
{
    /// <summary>
    /// CustomBorder will automatically close its window after it is displayed.
    ...
    /// </summary>
    public class CustomBorder : Border, ICustomElement
    {
        /// <summary>
        /// Type+Function to invoke for optional verification.
        /// </summary>
        public static readonly DependencyProperty VerifierProperty = DependencyProperty.RegisterAttached("Verifier", typeof(string), typeof(CustomBorder), new PropertyMetadata(""));
        ...
        /// </summary>
        [CLSCompliant(false)]
        public void _FireRenderedEvent(object element)
        {
            // Call event handlers.
