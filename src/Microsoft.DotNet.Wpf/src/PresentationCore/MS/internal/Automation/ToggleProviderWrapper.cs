...
/// <summary>
/// Wrapper class for the <see cref="IToggleProvider"/> interface, calls through to the managed <see cref="AutomationPeer"/>
...
internal sealed class ToggleProviderWrapper : MarshalByRefObject, IToggleProvider
{
    ...
    /// <summary>
    /// Creates a wrapper for the given <see cref="AutomationPeer"/> and <see cref="IToggleProvider"/> interface.
    /// </summary>
