...
/// <summary>
/// Wrapper class for the <see cref="IVirtualizedItemProvider"/> interface, calls through to the managed <see cref="AutomationPeer"/>
...
internal sealed class VirtualizedItemProviderWrapper : MarshalByRefObject, IVirtualizedItemProvider
{
    ...
    /// <summary>
    /// Creates a wrapper for the given <see cref="AutomationPeer"/> and <see cref="IVirtualizedItemProvider"/> interface.
    /// </summary>
