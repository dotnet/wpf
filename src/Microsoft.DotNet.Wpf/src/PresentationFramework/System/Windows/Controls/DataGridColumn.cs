...
namespace System.Windows.Controls
{
    ...
    public abstract class DataGridColumn : DependencyObject
    {
        ...
        public static readonly DependencyProperty IsReadOnlyProperty =
            DependencyProperty.Register("IsReadOnly", typeof(bool), typeof(DataGridColumn),
                new FrameworkPropertyMetadata(BooleanBoxes.FalseBox, OnNotifyCellPropertyChanged, OnCoerceIsReadOnly));
        ...
        public static readonly DependencyProperty CanUserSortProperty =
            DependencyProperty.Register(
                ...
                typeof(bool),
                typeof(DataGridColumn),
                new FrameworkPropertyMetadata(BooleanBoxes.TrueBox, new PropertyChangedCallback(OnCanUserSortPropertyChanged), new CoerceValueCallback(OnCoerceCanUserSort)));
        ...
        private static readonly DependencyPropertyKey IsFrozenPropertyKey =
            DependencyProperty.RegisterReadOnly(
                ...
                typeof(bool),
                typeof(DataGridColumn),
                new FrameworkPropertyMetadata(BooleanBoxes.FalseBox, new PropertyChangedCallback(OnNotifyFrozenPropertyChanged), new CoerceValueCallback(OnCoerceIsFrozen)));
        ...
        public static readonly DependencyProperty CanUserReorderProperty =
            DependencyProperty.Register("CanUserReorder", typeof(bool), typeof(DataGridColumn),
                new FrameworkPropertyMetadata(BooleanBoxes.TrueBox, new PropertyChangedCallback(OnNotifyColumnPropertyChanged), new CoerceValueCallback(OnCoerceCanUserReorder)));
        ...
        public static readonly DependencyProperty CanUserResizeProperty =
            DependencyProperty.Register("CanUserResize", typeof(bool), typeof(DataGridColumn),
                new FrameworkPropertyMetadata(BooleanBoxes.TrueBox, new PropertyChangedCallback(OnNotifyColumnHeaderPropertyChanged), new CoerceValueCallback(OnCoerceCanUserResize)));
