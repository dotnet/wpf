...
namespace System.Windows.Input
{
    ...
    internal sealed class PenContexts
    {
        ...
        internal void Enable()
        {
            ...
            {
                // create contexts
                _contexts = _stylusLogic.WispTabletDevices.CreateContexts(_inputSource.Value.Handle, this);
        ...
        internal void AddContext(uint index)
        {
            ...
            if (_contexts != null && index <= _contexts.Length && _inputSource.Value.Handle != IntPtr.Zero)
            {
                ...
                PenContext newContext = _stylusLogic.TabletDevices[(int)index].As<WispTabletDevice>().CreateContext(_inputSource.Value.Handle, this);
