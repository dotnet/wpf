...
public class XamlTypeTests
{
    ...
    public static IEnumerable<object?[]> LookupAliasedProperty_TestData()
    {
        ...
        yield return new object?[]
        {
            new CustomXamlType(typeof(int), new XamlSchemaContext())
            {
                LookupCustomAttributeProviderResult = new CustomAttributeProvider
                {
                    GetCustomAttributesAction = (attributeType, inherit) => new object[0]
                }
            },
            XamlLanguage.Lang,
            null
    ...
    {
        IEnumerable<XamlMember> expectedGetAllMembers = expectedGet ?? expectedLookup ?? new XamlMember[0];
...
#pragma warning restore 0618
    ...
    public static IEnumerable<object?[]> CanAssignTo_TestData()
    {
        ...
        foreach (byte[]? keyToken in new object?[] { null, new byte[0], new byte[] { 183, 122, 92, 86, 25, 52, 224, 138 } })
        {
