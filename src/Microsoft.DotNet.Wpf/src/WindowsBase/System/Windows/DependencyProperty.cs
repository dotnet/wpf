...
namespace System.Windows
{
    ...
    public sealed class DependencyProperty
    {
        ...
        public static DependencyProperty Register(string name, Type propertyType, Type ownerType, PropertyMetadata typeMetadata, ValidateValueCallback validateValueCallback)
        {
            ...
            if (typeMetadata is not null && typeMetadata.DefaultValueWasSet())
            {
            ...
            bool checkThreadAffinity)
        {
            ...
            if (checkThreadAffinity)
            {
                ...
                if (dispatcherObject is not null && dispatcherObject.Dispatcher is not null)
                {
                    ...
                    if (valueAsISealable is not null && valueAsISealable.CanSeal)
                    {
        ...
        public bool ReadOnly
        {
            get
            {
                return (_readOnlyKey is not null);
            }
        }
