...
namespace Microsoft.Test.Serialization.CustomElements
{
    ...
    /// </summary>
    public class CustomPage : Page, ICustomElement
    {
        /// <summary>
        /// Type+Function to invoke for optional verification.
        /// </summary>
        public static readonly DependencyProperty VerifierProperty = DependencyProperty.RegisterAttached("Verifier", typeof(string), typeof(CustomPage), new PropertyMetadata(""));
