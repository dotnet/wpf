...
namespace System.Windows.Controls
{
    ...
    public sealed class TextSearch : DependencyObject
	{
        ...
        /// For example: length of prefix would be 5 and the rest would be 2 if matchedText is "Grosses" and newText is ""Gro�"
        /// length of prefix would be 4 and the rest would be 2 if matchedText is ""Gro�es" and newText is "Gross" as "�" = "ss"
        /// </summary>
        ...
        internal static MatchedTextInfo FindMatchingPrefix(ItemsControl itemsControl, string prefix)
        {
            ...
            // for example: "Grosses" would match for the input text "Gro�" where the prefix length in matched text is 5
            // whereas the length of the inputted text is 4. Same matching rule applies for the other way as well with
            // "Gro�" in matched text for the inputted text "Gross"
