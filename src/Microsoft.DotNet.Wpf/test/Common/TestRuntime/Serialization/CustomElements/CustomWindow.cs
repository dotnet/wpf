...
{
    /// <summary>
    /// CustomPage will automatically close its window after it is displayed.
    ...
    public class CustomWindow : Window, ICustomElement
    {
        /// <summary>
        /// Type+Function to invoke for optional verification.
        /// </summary>
        public static readonly DependencyProperty VerifierProperty = DependencyProperty.RegisterAttached("Verifier", typeof(string), typeof(CustomWindow), new PropertyMetadata(""));

        /// <summary>
        /// Getter/Setter for VerifierProperty.
        /// </summary>
